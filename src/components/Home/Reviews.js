    ...
    return (
        <div className='reviews'>
            <div>
                ...
                <br /> <br />
                <Typography gutterBottom variant="h5" align="center"  component="div" style={{fontFamily:"Arial"}}>"Nice Position"</Typography>
            ...
            <div>
                ...
                <br /> <br />
                <Typography gutterBottom variant="h5" align="center" component="div" style={{fontFamily:"Arial"}}>"Perfect Stay"</Typography>
                <Typography  variant="body2" component="div" style={{fontFamily:"sans-serif",fontWeight:"light",color:"grey",padding:"0% 5% 0% 5%"}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, voluptate! Lorem ipsum dolor sit amet.Doloremque, voluptate! Lorem ipsum dolor sit amet</Typography>
                <br />
            ...
            <div>
                ...
                <br /> <br />
                <Typography gutterBottom variant="h5" align="center" component="div" style={{fontFamily:"Arial"}}>"Best Fit"</Typography>
                <Typography  variant="body2" component="div" style={{fontFamily:"sans-serif",fontWeight:"light",color:"grey",padding:"0% 5% 0% 5%"}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, voluptate! Lorem ipsum dolor sit amet.Doloremque, voluptate! Lorem ipsum dolor sit amet</Typography>
                <br />
